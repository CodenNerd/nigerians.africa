  ...
  return (
    <div>
      <section className="hero-field relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-y-0 right-0 z-0 hidden w-1/2 items-center justify-end lg:flex">
          <div className="pointer-events-auto w-[92%] max-w-none pr-4">
